...
const Staples = () => {
  ...
  useEffect(() => {
    ...
    socket.on("new staples", (staplesDetails) => {
      setAllData((pre) => [...pre, staplesDetails]);
    });
    return () => {
      socket.disconnect();
    };
