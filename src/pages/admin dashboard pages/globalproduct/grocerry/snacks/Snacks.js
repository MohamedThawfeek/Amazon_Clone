...
const Snacks = () => {
  ...
  useEffect(() => {
    ...
    socket.on("new snacks", (snacksDetails) => {
      setAllData((pre) => [...pre, snacksDetails]);
    });
    return () => {
      socket.disconnect();
    };
      ...
      {addProduct ? (
        <div className={style.boxes}>
          ...
          <div className={style.input}>
            ...
            <input
              type="text"
              placeholder="Enter your product flavour"
              onChange={handelChange}
              value={input.flavour}
              name="flavour"
            />{" "}
