...
import style from "./WashingMachine.module.css";
...
const WashingMachine = () => {
  ...
  useEffect(() => {
    const washingMachine = async () => {
      try {
        const { data } = await axios.get(
          "/api/homeAppliance/washing_Machine/all",
          {
            headers: {
  ...
  useEffect(() => {
    socket.connect();
    socket.on("new washing_machines", (washing_machineDetails) => {
      setAllData((pre) => [...pre, washing_machineDetails]);
    });
    return () => {
      socket.disconnect();
    };
  ...
  const del = async (id) => {
    try {
      const { data } = await axios.delete(
        `/api/homeAppliance/washing_Machine/delete/${id}`,
  ...
  const edit = async () => {
    try {
      const { data } = await axios.put(
        `/api/homeAppliance/washing_Machine/update/${id}`,
        input,
  ...
  const add = async () => {
    try {
      const { data } = await axios.post(
        `/api/homeAppliance/washing_Machine/add`,
        input,
